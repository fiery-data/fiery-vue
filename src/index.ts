...
import getInstance, {
  constants, define, setGlobalOptions, mergeStrategy, mergeOptions, stats, callbacks, destroyGlobalCache, getCacheForData, destroyCache, getOptions, FieryInstance, FierySources
} from 'fiery-data'
